...
await using (var scope = app.Services.CreateAsyncScope())
{
    ...
    // Idempotent safety-net: create tables that may have been falsely marked
    // as applied in __EFMigrationsHistory without actually being created.
    await db.Database.ExecuteSqlRawAsync("""
    ...
    await db.Database.ExecuteSqlRawAsync("""
        CREATE TABLE IF NOT EXISTS "PaypalSettings" (
            ...
            CONSTRAINT "PK_PaypalSettings" PRIMARY KEY ("Id")
        )
        """);
}
